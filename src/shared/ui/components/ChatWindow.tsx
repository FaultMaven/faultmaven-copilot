            ...
            {item.question && (
              <div className="flex justify-end px-4 py-2" data-turn={item.turn_number}>
                ...
                >
                  ...
                  {/* Attachment chips removed — the case header's "Files" section
                      tracks uploaded files. Inline chips were redundant and added
                      visual noise during the optimistic/loading phase. */}
