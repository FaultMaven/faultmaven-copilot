...
export function ConversationItem({ 
  ...
  return (
    <div
      ...
      aria-label={`Select case: ${displayTitle}`}
    >
        ...
        <div className="flex-1 min-w-0">
          {isRenaming ? (
            <input
              ...
              className="text-sm font-medium w-full bg-white border border-blue-300 rounded px-1 py-0.5 focus:outline-none focus:ring-1 focus:ring-blue-500"
              autoFocus
            ...
            <div className="flex items-center gap-2">
              ...
              {isUnsavedNew && (
                <span className="text-xs text-orange-500 bg-orange-100 px-1.5 py-0.5 rounded-full font-medium">
                  New
                </span>
              )}
            </div>
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          {onRename && (
            <button
              ...
              aria-label={`Rename case: ${displayTitle}`}
              title="Rename case"
            >
          ...
          {onDelete && (
            <button
              ...
              aria-label={`Delete case: ${displayTitle}`}
              title="Delete case"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
