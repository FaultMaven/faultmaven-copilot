...
export default function DocumentRowEnhanced({ 
  ...
  return (
    <tr className="hover:bg-fm-surface">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            {document.description && (
              <div className="text-xs text-fm-text-tertiary truncate mt-0.5" title={document.description}>
                {document.description}
              </div>
            )}
          </div>
          ...
          {(() => {
            ...
            return tags.length > 0 ? (
              <>
                {tags.slice(0, 2).map((tag, index) => (
                  <span
                    ...
                    className={`inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium ${
                      isStringTags 
                        ? 'bg-fm-warning-bg text-fm-warning border border-fm-warning-border' 
                ...
                {tags.length > 2 && (
                  <span 
                    className="text-xs text-fm-text-tertiary"
      ...
      {/* Category */}
      <td className="px-2 py-3 whitespace-nowrap text-xs text-fm-text-tertiary" style={{ width: '100px', minWidth: '100px' }}>
      ...
      <td className="px-2 py-3 whitespace-nowrap text-right" style={{ width: '140px', minWidth: '140px' }}>
        <div className="flex items-center justify-end space-x-2">
          ...
          <button
            ...
            className="inline-flex items-center px-2 py-1 border border-fm-border text-xs leading-4 font-medium rounded text-fm-text-primary bg-fm-surface hover:bg-fm-surface focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fm-accent"
          ...
          <button
            ...
            disabled={isDeleting}
            className="inline-flex items-center px-2 py-1 border border-transparent text-xs leading-4 font-medium rounded text-white bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fm-critical"
