...
/**
 * Exported because it is part of a public signature: `usePendingOperations`
 * returns it, so a consumer compiling against this package's declarations has
 * to be able to name it. A standalone declaration build is what catches that —
 * inside one repository the type is simply inferred and nobody notices.
 */
